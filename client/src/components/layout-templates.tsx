              ...
              <Card className="w-full border-0 shadow-none">
                <CardContent className="p-2 sm:p-3 relative">
                  ...
                  <div className="text-left">
                    <h3 className="font-medium text-xs sm:text-sm mb-0.5 leading-tight">{template.name}</h3>
                    <p className="text-[10px] sm:text-xs text-muted-foreground line-clamp-2 leading-tight">{template.description}</p>
                    <p className="text-[10px] text-muted-foreground mt-0.5">{template.panelCount} panels</p>
                  </div>
                </CardContent>
              </Card>
            </Button>
